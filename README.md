...
- [Android 실기기 화면 사용자 가이드](docs/ANDROID-USER-GUIDE.md)
- [iOS 앱 설정·실기기 테스트](ios-app/README.md)
- [iPhone 실기기 화면 사용자 가이드](docs/IPHONE-USER-GUIDE.md)
- English user guides: [Android](docs/ANDROID-USER-GUIDE.en.md) · [iPhone](docs/IPHONE-USER-GUIDE.en.md)
