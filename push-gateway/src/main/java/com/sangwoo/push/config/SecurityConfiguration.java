...
public class SecurityConfiguration {
    /** Always protected, including when test-page authentication is disabled. */
    @Bean
    @Order(1)
    SecurityFilterChain enrollmentSecurity(HttpSecurity http) throws Exception {
        return http.securityMatcher("/internal/push/enrollment/**")
                .authorizeHttpRequests(auth -> auth.anyRequest()
                        .hasAnyRole("PUSH_ADMIN", "PUSH_ENROLLMENT_ISSUER"))
